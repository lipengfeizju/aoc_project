...
int main(int argc, char **argv) {
  ...
  //ros::ServiceClient params_client = nh.serviceClient<ffld_ros::SetDpmParams>("set_dpm_params");
  ros::ServiceClient detection_client = nh.serviceClient<ffld_ros::DetectObject>("detect_object");
  params = new dpm_detect_client::Params;
  ...
  ffld_ros::DetectObject srv;
  srv.request.img = *(cv_bridge::CvImage(std_msgs::Header(), "mono8", image).toImageMsg()); //TODO: Is this efficient??
  //srv.request.model = 0;
